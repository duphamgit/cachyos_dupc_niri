...
pub struct LauncherTheme {
    ...
    /// Visual thickness (simulated) for the neon border (used via padding)
    #[serde(with = "pixels_serde")]
    pub neon_border_thickness: Pixels,
    /// Frequency of the neon pulse in Hz
    pub neon_frequency: f32,
    /// Intensity multiplier for the neon pulse (0.0 - 1.0)
...
impl Default for LauncherTheme {
    fn default() -> Self {
        Self {
            ...
            item_margin_y: px(4.0),
            item_padding_x: px(10.0),
            item_padding_y: px(10.0),
